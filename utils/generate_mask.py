...
def get_uniform_random_mask(image_size, ny, acc, acs_lines=24):
    ...
    mask = np.repeat(mask[np.newaxis, :], ny, axis=0)
...
def get_cartesian_mask(acc, acs_lines=24, nx = 256, ny = 302):
    shape = (1, nx, ny)
...
def main():
    ...
    # get_uniform_random_mask(256,302,4,24)
    get_cartesian_mask(4, acs_lines=24, nx = 256, ny = 302)
