...
- `example1.mat`, `example2.mat`: anonymized examples from two different
  volunteers.
...
The repository includes two anonymized example files from two different
volunteers. They are provided only to demonstrate the expected input format.

Each example contains:

- `ksp`: `(1, 302, 256, 18)`, complex64
- `kspace`: `(1, 302, 256, 18)`, complex64
